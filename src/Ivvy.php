...
class Ivvy
{
    const REGION_UK = 'eu-west-2';
    const REGION_US = 'us-west-2';
     ...
     */
    public static function makeBaseUri($region = null)
    {
        if (!$region) {
            $region = static::REGION_US;
        }
        return 'https://api.' . $region . '.ivvy.com';
    }
     ...
     * @return contact|null
     */
    public function addOrUpdateContact(array $data, int $id = null)
    {
